...
const card = [
    {
        category: 'サブ',
        title: 'スプラッシュボム',
        body: '着地して<mark>しばらくすると爆発する</mark>ボム。',
    },
    {
        category: 'サブ',
        title: 'キューバンボム',
    ...
    },
    {
        category: 'メイン',
        title: 'デュアルスイーパー',
        body: '<mark>射程が長い</mark>マニューバー。スライド後に立ち止まって撃ち続けると<mark>射程が少し伸びる</mark>。スライドは2回連続で可能。',
    },
    {
        category: 'メイン',
        title: 'ボールドマーカー',
    ...
    },
    {
        category: 'メイン',
        title: 'ケルビン525',
        body: '<mark>スライド後の攻撃力が上がる</mark>マニューバー。<mark>2回連続でスライドできる。</mark>。連射は遅い。',
    },
    {
        category: 'メイン',
        title: 'デンタルワイパーミント',
    ...
    },
    {
        category: 'メイン',
        title: 'クーゲルシュライバー',
        body: '<mark>撃ち始めは連射が速いが撃ち続けると変化して射程が長く弾ブレが小さくなる</mark>スピナー。発射中に<mark>再チャージができる</mark>。撃ち始めは射程が短く弾ブレが大きく、変化後は連射が遅め。',
    },
    {
        category: 'ブキセット',
        title: 'スプラシューター',
